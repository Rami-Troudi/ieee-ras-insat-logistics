...
1. **Journey 1: Discovery to Request Submission**
   ...
   - Redirected to `/app/requests/REQ-2026-...` verifying pending status, line item decisions, and activity timeline.
...
3. **Journey 3: Active Loan & Due Date Extension**
   ...
   - Verified extension request timeline status and history.
...
7. **Scenario 7: Strike 2 Advisory on Cart**
   - Verified member with 2 active strikes receives advisory notice regarding equipment constraints.
8. **Scenario 8: Provisional User Notice on Cart**
   - Verified newly registered / provisional members receive notification that borrowing requires board processing.
